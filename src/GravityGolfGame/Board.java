...
public class Board extends JPanel {
	...
	public void load(){
		...
		triangles.add(new Triangle(getCellAt(11, 10), Type._30, Orientation.DOWN));
		
		triangles.add(new Triangle(getCellAt(17, 10), Type._60, Orientation.UP));
		triangles.add(new Triangle(getCellAt(14, 4), Type._30, Orientation.DOWN));
